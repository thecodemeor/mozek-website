 ...
 * BadgeComponent
 *
 * A reusable page component to document and display the MozBadge library component.
 *
 * @example
 * <moz-badge></moz-badge>
 */
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MozekCode, MozBadge, MozButton, MozIcon],
...
export class BadgeComponent {
  title = 'badge';
  description =
    'A badge is a small component that displays a number or status indicator, often used to show notifications or highlight important information.';
