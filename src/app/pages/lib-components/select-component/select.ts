 ...
 * SelectComponent
 *
 * A reusable page component to document and display the MozSelect library component.
 *
 * @example
 * <moz-select></moz-select>
 */
@Component({
  selector: 'app-lib-component',
  standalone: true,
  imports: [CommonModule, MozekCode, MozIcon, MozSelect, MozOption],
