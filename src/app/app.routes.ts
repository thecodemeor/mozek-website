...
export const routes: Routes = [
    ...
    { path: 'components', loadComponent: () => import('./pages/lib-components/lib-components').then(m => m.LibComponents),
        children: [
            ...
            { path: 'breadcrumbs', loadComponent: () => import('./pages/lib-components/breadcrumbs-component/breadcrumbs').then(m => m.Breadcrumbs) },
            ...
            { path: 'dialog', loadComponent: () => import('./pages/lib-components/dialog-component/dialog').then(m => m.Dialog) },
            { path: 'divider', loadComponent: () => import('./pages/lib-components/divider-component/divider').then(m => m.Divider) },
            { path: 'icon', loadComponent: () => import('./pages/lib-components/icon-component/icon').then(m => m.Icon) },
            { path: 'input', loadComponent: () => import('./pages/lib-components/input-component/input').then(m => m.Input) },
            { path: 'menu', loadComponent: () => import('./pages/lib-components/menu-component/menu').then(m => m.Menu) },
            ...
            { path: 'snackbar', loadComponent: () => import('./pages/lib-components/snackbar-component/snackbar').then(m => m.Snackbar) },
            { path: 'snackbar-queue', loadComponent: () => import('./pages/lib-components/snackbar-queue-component/snackbar-queue').then(m => m.SnackbarQueue) },
            { path: 'switch', loadComponent: () => import('./pages/lib-components/switch-component/switch').then(m => m.Switch) },
            { path: 'tooltip', loadComponent: () => import('./pages/lib-components/tooltip-component/tooltip').then(m => m.Tooltip) },
            { path: 'tutor', loadComponent: () => import('./pages/lib-components/tutor-component/tutor').then(m => m.Tutor) }
        ]
    },
